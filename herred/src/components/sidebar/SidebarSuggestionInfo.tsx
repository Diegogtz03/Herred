  ...
  return (
    <div className="flex flex-col h-full pb-6">
      <div className="flex justify-start items-center pb-3">
        ...
        <div>
          <h2 className="text-sm">Sugerencias:</h2>
          <h1 className="text-red-950 font-bold text-xl whitespace-normal break-words">
            {selectedNode?.name}
          </h1>
        </div>
      </div>
...
// export default function SidebarSuggestionInfo() {
//   const { setAlgorithmResponse, algorithmResponse, selectedNode } =
//     useContext(NetworkContext);
//   setAlgorithmResponse(dummyResponse);
//   return (
//     <div className="flex flex-col n h-full">
//       <div className="flex justify-start items-center pb-3">
//         <RocketLaunchIcon className="flex-shrink-0 h-5 w-5 cursor-pointer hover:text-blue-500 mr-4" />
//         <div>
//           <h2 className="text-sm">Sugerencias:</h2>
...
//       {algorithmResponse && algorithmResponse.result.length > 0 && (
//         <>
//           <div className="w-full overflow-y-auto custom-scrollbar flex flex-col space-y-2">
//             {algorithmResponse.result.map((item, index) => (
